...
export interface SecurityReadinessReport {
  ...
  readonly targetBranch: "feature/telegram-operator-console";
...
const FEATURE_BRANCH = "feature/telegram-operator-console";
  ...
  const baseChecks: SecurityReadinessCheck[] = [
    ...
    check(
      ...
      targetReady &&
        ...
        value?.branch !== "main",
      "UPDATED_FEATURE_TARGET_SELECTED",
    ),
    check(
      "deep_security_scan",
      scanReady,
...
function validScanResult(
  ...
  return (
    ...
    candidate.branch === FEATURE_BRANCH &&
