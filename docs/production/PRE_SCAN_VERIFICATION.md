...
final commit has been pushed to `feature/telegram-operator-console`. The command
...
`origin/feature/telegram-operator-console`. It resolves the exact remote branch
